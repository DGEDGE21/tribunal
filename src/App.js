  ...
  return (
       ...
       <Router>
        ...
        <Switch>
          ...
          <Route path="/home/Certidoes/historico" exact component={Historico}/>
          {/*Admin */}
          ...
          <Route path="/opera/home/relatorios" exact component={ORelatorios}/>
          
          <Route path="/opera/home/documento/:id" exact component={ODocumento}/>
