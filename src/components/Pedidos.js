...
function Pedidos() {
  ...
  return (
    <div className="comp">
      <Space className="espaco" align="vertical">
        {phase1 && (
          <>
            {data && (
              <>
        ...
        <>
          <div className="Resumo_pedido">
            ...
            <div className="foot23">
              ...
              {download && (
                <>
                  <Button className="stp" onClick={handleUpload}>
                    Baixar
                    <DownloadOutlined />
                  </Button>
                </>
            ...
            <div className="A4">
              ...
              <div>
                ...
                <h3 className="h3numero">
                  CERTIDÃO N° 4326/{data_empresa.provinvia}/SG/0
                  {phase2.idPedido}
                </h3>
              </div>
              <div className="body">
                <p>
                  SEVERINO RICARDO DE CARVALHO, Distribuidor Provincial do
                  Tribunal Judicial da Cidade de Maputo
                </p>
                <p>
                  CERTIFICA QUE, compulsando os livros de entrada de acções e
                  papéis diversos existentes nesta Distribuição - Geral,{" "}
                  ...
                  , qualquer acção em que a empresa{" "}
                  <text>{data_empresa.nome}</text> , decreta falência ou requer
                  concordata.
                </p>
                <p>
                  É tudo quanto me cumpre certificar em face ao requerimento e
                  do que os referidos livros reportam.
                </p>

                <p>
                  Distribuição - Geral do Tribunal Judicial da Cidade de Maputo,
                  aos{" "}
              ...
              <div className="infos_09">
                ...
                <text className="a">Cristóvão Zacarias</text>
              </div>

              <div>
                <QRCode
                  className="Qrcode_place"
                  value={`http://localhost:3000/opera/home/documento/${phase2.serialNumber}`}
                />
              </div>
            </div>
          </div>
